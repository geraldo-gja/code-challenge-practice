package kwan.prova2.q02.banking.original.test;

import kwan.prova2.q02.banking.original.Bank;
import kwan.prova2.q02.banking.original.BankInterface;
import kwan.prova2.q02.banking.original.CommercialAccount;
import kwan.prova2.q02.banking.original.Company;
import kwan.prova2.q02.banking.original.ConsumerAccount;
import kwan.prova2.q02.banking.original.Person;
import kwan.prova2.q02.banking.original.Transaction;
...
//TODO import static org.junit.Assert.assertNotEquals;
...
public class HiddenTest {
    ...
    public void transactionDebitTest() throws Exception {
      ...
      //TODO  double beforeDeposit1 = transaction1.getBalance();
        double amount = 500.0;
